...
\newcites{JP}{International Journal Papers}
\newcites{CP}{International Conference Papers}
\newcites{WS}{International Workshop Papers}
\newcites{TR}{Technical Reports}
\newcites{ED}{Editing}
\newcites{CH}{Book Chapters}
...
\section{Supervision}
{
  ...
  \input{supervision-modified.tex}
}
...
\nociteJP{*}
\bibliographystyleJP{plainyr-rev}
\bibliographyJP{my-journals}

\nociteCH{*}
\bibliographystyleCH{plainyr-rev}
\bibliographyCH{my-chapters}
...
\nociteCP{*}
\bibliographystyleCP{plainyr-rev}
\bibliographyCP{my-conferences}

\nociteWS{*}
\bibliographystyleWS{plainyr-rev}
\bibliographyWS{my-workshops}
