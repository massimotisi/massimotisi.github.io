...
Since 2010, I hold an Associate Professor (Maitre de Conference) position at IMT Atlantique (formerly Mines Nantes). 
...
I am widely recognized as an expert in model transformation, notably for extending the model-transformation paradigm to higher-order model transformations, and for my contributions to the ATL language since 2010. In particular, my article "On the Use of Higher-Order Model Transformations" has collected 179 citations since 2009 (up to July 2017 - Google Scholar). I have an h-index of 17 (July 2017 - Google Scholar).

My recent work on model-transformation verification has been well received by the research community (by two nominations as best paper in the leading conferences Etaps and ICST). 
